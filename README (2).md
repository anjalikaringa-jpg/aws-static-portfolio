# The Chai Cloud Lounge — Static Website Hosting with Amazon S3 + CloudFront

A hands-on AWS project where I deployed a static restaurant/menu website —
**The Chai Cloud Lounge** — using **Amazon S3** for storage and
**Amazon CloudFront** as a global content delivery network (CDN), secured
with **Origin Access Control (OAC)**.

## About the site

The Chai Cloud Lounge is a single-page, dark-themed "haute dining" menu
site built with plain HTML/CSS. It showcases categorized menu sections
(elixirs/beverages, woodfired sourdough pizzas, etc.) with card-based
layouts, hover animations, and a responsive design that adapts down to
mobile screens.

## What I built

- Created an **S3 bucket** to store the website's static files (`index.html`
  and any accompanying assets)
...
- How to structure and style a polished, responsive static webpage with
  pure HTML/CSS (custom fonts, CSS variables/theming, hover effects,
